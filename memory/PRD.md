...
- `frontend/src/pages/ReportsPage.jsx` — Reports UI (selector + table viewer)
...
- 7 industry-standard FX trading reports with **tabular data view first**, then export
- Report selector page → click → full data table with filters + CSV/PDF export
- **Deal Blotter**: Complete deal log (date, status, client, currency filters)
